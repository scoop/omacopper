...
// spawns reads or writes the person's notes, and an inherited environment
// carries BASH_ENV, LD_PRELOAD and PYTHONPATH into it — each of which lets
// another process running as this user decide what code runs.
Process {
    id: root
    ...
    /** Exit code of the last run, valid inside finishedWith. */
    ...
    environment: ({
            ...
            PATH: "/usr/bin:/bin",
            // wl-paste finds the compositor through these two and nothing else.
